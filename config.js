...
//config.applicationId = 'amzn1.ask.skill.1710abc5-bf17-4db0-ab6e-36179d664980';
config.applicationId = mylogin.applicationId;
...
config.HA_protocol = mylogin.HA_protocol;

// HA server username
config.HA_user = mylogin.HA_user;

// HA server password
config.HA_password = mylogin.HA_password;

// HA server FQDN/IP
config.HA_host = mylogin.HA_host;

// HA server port
config.HA_port = mylogin.HA_port;
